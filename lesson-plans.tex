...
\begin{itemize}
  ...
  \item Circuit Breakers and Fuses -- Most are "push to reset" except
    "Alternator Output" and "Landing Gear" which are "pull-off" type and the
    "AVN PWR" which is a rocker switch; cigarette lighter and control wheel map
    light uses fuses as well as breakers
