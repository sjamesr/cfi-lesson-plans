...
\include{systems}
\include{fuel-system-c172rg}
\include{electrical-system-c172rg}
\include{landing-gear-c172rg}
\include{propeller}
\include{vfr-instruments}
\include{docs-and-maintenance}
\include{weight-and-balance}
\include{weather-theory}
\include{weather-services}
\include{airspace}
\include{airport-operations}
\include{emergency-procedures}
\include{visual-illusions}
\include{spin-avoidance}
\include{vfr-flight-planning}
