...
\end{table}
  ...
  \item{Rudder}
    \begin{itemize}
      ...
      \item Most light airplanes have one rudder, located on the trailing edge of the vertical stabilizer

      \item Controlled through the use of foot pedals, connected to the rudder by bell cranks, cables and pulleys
      ...
      \item Rudder trim: most light aircraft are equipped with some form of
        ...
        surface, deflecting the control surface to relieve control pressure and
        maintain a constant yaw attitude; some may be a "manual rudder trim" or
        a piece of metal that is manually adjusted before flight
    \end{itemize}
