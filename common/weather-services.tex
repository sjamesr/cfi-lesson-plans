...
AC 00-6B Aviation Weather, Sectional or Terminal chart.
...
To contact FSS: 1-800-WX-BRIEF, visit in person, 122.2 or discrete frequency
(see sectional chart). A FSS standard briefing gives complete and customized
description of all conditions that may affect the proposed flight, based on
route and altitude to by flown. Includes adverse conditions, synopsis, current
and forecast conditions, winds and temps aloft, NOTAMs, anything else
requested.
...
Aviation weather products are described in AC 00-45H.
...
\begin{itemize}
  ...
  \item Aviation Routine Weather Report (METAR) (AIM 7-1-30):
    ...
    \end{itemize}
  \item Pilot Weather Report PIREPs (UA/UUA):
    \begin{itemize}
...
\begin{itemize}
  ...
  \item Graphical Area Forecast (GFA):
    \begin{itemize}
      \item web-based displays expected to provide necessary aviation weather
        information to give users a complete picture of the weather that map
        impact flights in the continental US
      \item updated continuously
    \end{itemize}
...
\begin{itemize}
  \item Exhibit knowledge of the elements related to weather information by
    ...
    \end{itemize}
  \item Make a competent ``go/no-go'' decision based on available weather
    information.
\end{itemize}

\subsection{References}

AC 00-6B Aviation Weather, AC 00-45H Aviation Weather Products, FAA-H-8083-25B
Pilot's Handbook of Aeronautical Knowledge Chapter 13.
